...
racedef_use_name = [0,3,6,15,47,49,63,68,69,70,71,72,73]
racedef_use_species = [1,4,14,46,48]
racedef_jock_dependent = [9,53,54,56,57,59,60]
racedef_use_species_param = [10,11,13,16,18,19,22,23,26,27,38,39,40,41,42,43,44,45,46,50,51,52,53,56,59,61,64,65,66,67]
racedef_use_species_bodytype = [12,17,20,21,24,25,28]
            ...
            if i in racedef_use_name:
                ...
                if i in [13, 38, 39, 42, 43]:
                    ...
                    if villager_species in species_is_avian:
                        race_file += race_file_tail_bodypart_avian
                    else:
                        race_file += race_file_tail_bodypart_nonavian
                elif i == 50:
                ...
                if villager_name == 'Ankha':
                    ...
                    race_file +=  race_file_no_accessory
            elif i == 2:
                if villager_name == 'Rover':
                    race_file += 'amiable traveler'
                else:
                    personality_lower = villager_personality.lower()
                    race_file += personality_lower + ' villager'
            elif i == 7:
